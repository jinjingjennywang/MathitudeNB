...
t.test(How~Group,data=output.core)
t.test(When.estimate~Group,data=output.core)

```

```{r}
######### linear regression ###########
fit.lm <- lm(When.estimate~Group,data=output.core)
lm.beta(fit.lm)
```
...
```{r}
fit.lm <- lm(When.estimate~Group,data=output.read)
lm.beta(fit.lm)
```
...
fit.lm <- lm(How~Group,data=output.core)
lm.beta(fit.lm)
```
...
```
```{r}
######################### plot summary (collapse core knowledge)
library(plotrix)

y=c(0,0.5,1,1.5,2,2.5,3,3.5,4,4.5,5,5.5)
x=c(-0.5:10.5)
summ_m$Empirical = c(5,1,1,1,1,1,1,1,1,1)

pdf(paste("mathitude_JP",currentcondition," actualage.pdf",sep=""),width=8,height=8)
plot(x,y,type = "n",xlab="Category",ylab="Timeline",xlim=c(-0.5,10.5),ylim=c(0.41,5.5),axes=FALSE)
##for presentation#axis(side=1,at = summ_m$Category.num,labels = summ_m$Category,col = "white")
###axis(side=4,col = "white")
axis(side=1,at = summ_m$Category.num,labels = summ_m$Category)
axis(side=4)
floating.pie(summ_m$Category.num[1],summ_m$mean[1],c(summ_m$a.born[1],summ_m$b.mature[1],summ_m$d.observe[1],summ_m$c.teach[1]),
             radius = 0.4,col=c("royalblue1","skyblue2","orange","darkorange1"),startpos = -2,border=NA)
floating.pie(summ_m$Category.num[2],summ_m$mean[2],c(summ_m$a.born[2],summ_m$b.mature[2],summ_m$d.observe[2],summ_m$c.teach[2]),
             radius = 0.4,col=c("royalblue1","skyblue2","orange","darkorange1"),startpos = -1.6,border=NA)
floating.pie(summ_m$Category.num[3],summ_m$mean[3],c(summ_m$a.born[3],summ_m$b.mature[3],summ_m$d.observe[3],summ_m$c.teach[3]),
             radius = 0.4,col=c("royalblue1","skyblue2","orange","darkorange1"),startpos = -1.6,border=NA)
floating.pie(summ_m$Category.num[4],summ_m$mean[4],c(summ_m$a.born[4],summ_m$b.mature[4],summ_m$d.observe[4],summ_m$c.teach[4]),
             radius = 0.4,col=c("royalblue1","skyblue2","orange","darkorange1"),startpos = -1.6,border=NA)
floating.pie(summ_m$Category.num[5],summ_m$mean[5],c(summ_m$a.born[5],summ_m$b.mature[5],summ_m$d.observe[5],summ_m$c.teach[5]),
             radius = 0.4,col=c(c("royalblue1","skyblue2","orange","darkorange1")),startpos = -1.6,border=NA)
floating.pie(summ_m$Category.num[6],summ_m$mean[6],c(summ_m$a.born[6],summ_m$b.mature[6],summ_m$d.observe[6],summ_m$c.teach[6]),
             radius = 0.4,col=c("royalblue1","skyblue2","orange","darkorange1"),startpos = -2,border=NA)
floating.pie(summ_m$Category.num[7],summ_m$mean[7],c(summ_m$a.born[7],summ_m$b.mature[7],summ_m$d.observe[7],summ_m$c.teach[7]),
             radius = 0.4,col=c("royalblue1","skyblue2","orange","darkorange1"),startpos = -2.2,border=NA)
floating.pie(summ_m$Category.num[8],summ_m$mean[8],c(summ_m$a.born[8],summ_m$b.mature[8],summ_m$d.observe[8],summ_m$c.teach[8]),
             radius = 0.4,col=c("royalblue1","skyblue2","orange","darkorange1"),startpos = -2.6,border=NA)
floating.pie(summ_m$Category.num[9],summ_m$mean[9],c(summ_m$a.born[9],summ_m$b.mature[9],summ_m$d.observe[9],summ_m$c.teach[9]),
             radius = 0.4,col=c("royalblue1","skyblue2","orange","darkorange1"),startpos = 2.2,border=NA)
floating.pie(summ_m$Category.num[10],summ_m$mean[10],c(summ_m$a.born[10],summ_m$b.mature[10],summ_m$d.observe[10],summ_m$c.teach[10]),
             radius = 0.4,col=c("royalblue1","skyblue2","orange","darkorange1"),startpos = 2.2,border=NA)
points(summ_m$Category.num,summ_m$Empirical,pch=3,col="green3",cex=1)
###box(col="white")
box()
par(bg=NA)
dev.off()
