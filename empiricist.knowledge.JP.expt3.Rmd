...
```{r}
######### linear regression ###########
output.core$religion=as.numeric(output.core$religion)
fit.lm <- lm(When.estimate~Condition+religion+evolution+crystal+fluid+bad.karma+good.karma+freewill+afterlife,data=output.core)
summary(fit.lm)
lm.beta(fit.lm)
