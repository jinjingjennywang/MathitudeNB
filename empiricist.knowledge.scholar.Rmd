---
title: "Experiment 7 academics' beliefs about human knowledge"
...
currentgroup = c("scholar")
currentcondition = c("natural","humanity","mind")
...
t.test(w.bias~Type,paired=TRUE,data=subset(summ.output,summ.output$Type!="sensory"))
...
summ.w <- describeBy(output.core$When.estimate,output.core$Condition,na.rm=TRUE,mat=TRUE)
